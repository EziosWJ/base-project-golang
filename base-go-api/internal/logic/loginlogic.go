...
func (l *LoginLogic) Login(req *types.LoginRequest) (resp *types.LoginToken, err error) {
	return service.NewAuthService(l.svcCtx.DB, l.svcCtx.Sessions).Login(l.ctx, req)
}
