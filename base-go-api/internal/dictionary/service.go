...
func NewService(store Store, audit AuditRecorder) (*Service, error) {
	...
	return &Service{store: store, audit: audit}, nil
}
...
func (s *Service) CreateType(ctx context.Context, meta AuditMetadata, input TypeInput) (DictType, error) {
	...
	value, err = s.store.CreateType(ctx, value)
	if err != nil {
		return DictType{}, err
	}
	return value, s.record(ctx, "dict-type.create", "dict-type", value.ID, "创建字典类型", meta)
}
...
func (s *Service) UpdateType(ctx context.Context, meta AuditMetadata, id int64, input TypeInput) (DictType, error) {
	...
	value, err = s.store.UpdateType(ctx, value)
	if err != nil {
		return DictType{}, err
	}
	return value, s.record(ctx, "dict-type.update", "dict-type", id, "更新字典类型", meta)
}
...
func (s *Service) DeleteType(ctx context.Context, meta AuditMetadata, id int64) error {
	...
	if err := s.store.DeleteTypes(ctx, []int64{id}); err != nil {
		return err
	}
	return s.record(ctx, "dict-type.delete", "dict-type", id, "删除字典类型", meta)
}
...
func (s *Service) DeleteTypes(ctx context.Context, meta AuditMetadata, ids []int64) error {
	...
	if err := s.store.DeleteTypes(ctx, ids); err != nil {
		return err
	}
	return s.record(ctx, "dict-type.batch-delete", "dict-type", 0, "批量删除字典类型", meta)
}
...
func (s *Service) SetTypeStatus(ctx context.Context, meta AuditMetadata, id int64, status int) error {
	...
	if err := s.store.SetTypeStatus(ctx, id, status); err != nil {
		return err
	}
	return s.record(ctx, "dict-type.status", "dict-type", id, "更新字典类型状态", meta)
}
...
func (s *Service) CreateData(ctx context.Context, meta AuditMetadata, input DataInput) (DictData, error) {
	...
	value, err = s.store.CreateData(ctx, value)
	if err != nil {
		return DictData{}, err
	}
	return value, s.record(ctx, "dict-data.create", "dict-data", value.ID, "创建字典数据", meta)
}
...
func (s *Service) UpdateData(ctx context.Context, meta AuditMetadata, id int64, input DataInput) (DictData, error) {
	...
	value, err = s.store.UpdateData(ctx, value)
	if err != nil {
		return DictData{}, err
	}
	return value, s.record(ctx, "dict-data.update", "dict-data", id, "更新字典数据", meta)
}
...
func (s *Service) DeleteData(ctx context.Context, meta AuditMetadata, id int64) error {
	...
	if err := s.store.DeleteData(ctx, []int64{id}); err != nil {
		return err
	}
	return s.record(ctx, "dict-data.delete", "dict-data", id, "删除字典数据", meta)
}
...
func (s *Service) DeleteDataBatch(ctx context.Context, meta AuditMetadata, ids []int64) error {
	...
	if err := s.store.DeleteData(ctx, ids); err != nil {
		return err
	}
	return s.record(ctx, "dict-data.batch-delete", "dict-data", 0, "批量删除字典数据", meta)
}
...
func (s *Service) record(ctx context.Context, action, resource string, id int64, summary string, meta AuditMetadata) error {
	return s.audit.Record(ctx, AuditEvent{Action: action, Resource: resource, ResourceID: id, Summary: summary, Metadata: meta})
}
